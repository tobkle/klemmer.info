...
export function AmpIncludeAmpFacebookComments() {
    return (
        <AmpIncludeCustomElement name="amp-facebook-comments" version="0.1" />
    )
}
...
export function AmpIncludeAmpPositionObserver() {
    return (
        <AmpIncludeCustomElement name="amp-position-observer" version="0.1" />
    )
}
...
export function AmpIncludeAmpUserNotification() {
    return (
        <AmpIncludeCustomElement name="amp-user-notification" version="0.1" />
    )
}
