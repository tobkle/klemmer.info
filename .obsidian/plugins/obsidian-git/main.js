...
var CustomMessageModal = /** @class */ (function (_super) {
  ...
  CustomMessageModal.prototype.onChooseSuggestion = function (item, _) {
    var _this = this
    this.plugin.promiseQueue.addTask(function () {
      return _this.plugin.createBackup(false, item)
    })
  }
  ...
  ObsidianGitSettingsTab.prototype.display = function () {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addText(function (text) {
        return text.setValue(String(plugin.settings.autoSaveInterval)).onChange(function (value) {
          if (!isNaN(Number(value))) {
            ...
            if (plugin.settings.autoSaveInterval > 0) {
              ...
              plugin.clearAutoBackup() && new obsidian.Notice('Automatic backup disabled!')
            }
          } else {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addText(function (text) {
        return text.setValue(String(plugin.settings.autoPullInterval)).onChange(function (value) {
          if (!isNaN(Number(value))) {
            ...
            if (plugin.settings.autoPullInterval > 0) {
              ...
              plugin.clearAutoPull() && new obsidian.Notice('Automatic pull disabled!')
            }
          } else {
            new obsidian.Notice('Please specify a valid number.')
          }
        ...
        return button.setButtonText('Preview').onClick(function () {
          return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  return [4 /*yield*/, plugin.gitManager.formatCommitMessage()]
                case 1:
      ...
      .addDropdown(function (dropdown) {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_b) {
            switch (_b.label) {
              case 0:
                return [4 /*yield*/, plugin.gitManager.branchInfo()]
              case 1:
                branchInfo = _b.sent()
                ...
                dropdown.onChange(function (option) {
                  return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                      switch (_a.label) {
                        case 0:
                          return [4 /*yield*/, plugin.gitManager.checkout(option)]
                        case 1:
                          _a.sent()
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle.setValue(plugin.settings.autoPullOnBoot).onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle.setValue(plugin.settings.disablePush).onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle.setValue(plugin.settings.pullBeforePush).onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle.setValue(plugin.settings.updateSubmodules).onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle.setValue(plugin.settings.disablePopups).onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle.setValue(plugin.settings.showStatusBar).onChange(function (value) {
...
var util = createCommonjsModule(function (module, exports) {
  ...
  exports.pick =
    ...
    exports.prefixedArray =
    exports.asNumber =
    exports.asStringArray =
    exports.asArray =
    ...
    exports.forEachLineWithContent =
    exports.toLinesWithContent =
    exports.last =
    exports.first =
    exports.splitOn =
    exports.isUserFunction =
    exports.asFunction =
    exports.NOOP =
      void 0
...
var argumentFilters = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, '__esModule', { value: true })
  exports.filterHasLength =
    exports.filterFunction =
    exports.filterPlainObject =
    exports.filterStringOrStringArray =
    exports.filterStringArray =
    exports.filterString =
    exports.filterPrimitives =
    exports.filterArray =
    exports.filterType =
      void 0
  ...
  const filterStringOrStringArray = (input) => {
    return (
      exports.filterString(input) || (Array.isArray(input) && input.every(exports.filterString))
    )
  }
...
var taskOptions = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, '__esModule', { value: true })
  exports.trailingFunctionArgument =
    exports.trailingOptionsArgument =
    exports.getTrailingOptions =
    exports.appendTaskOptions =
      void 0
...
var checkIsRepo = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, '__esModule', { value: true })
  exports.checkIsBareRepoTask =
    exports.checkIsRepoRootTask =
    exports.checkIsRepoTask =
    exports.CheckRepoActions =
      void 0
...
var task = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, '__esModule', { value: true })
  exports.isEmptyTask =
    exports.isBufferTask =
    exports.straightThroughBufferTask =
    exports.straightThroughStringTask =
    exports.configurationErrorTask =
    exports.adhocExecTask =
...
var clean = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, '__esModule', { value: true })
  exports.isCleanOptionsArray =
    exports.cleanTask =
    exports.cleanWithOptionsTask =
    exports.CleanOptions =
    exports.CONFIG_ERROR_UNKNOWN_OPTION =
    ...
    return {
      addConfig(key, value, ...rest) {
        return this._runTask(
          ...
          utils.trailingFunctionArgument(arguments)
        )
      },
      getConfig(key, scope) {
        return this._runTask(
...
var pluginStore = createCommonjsModule(function (module, exports) {
  ...
  class PluginStore {
    ...
    add(plugin) {
      ...
      utils
        .asArray(plugin)
        .forEach((plugin) => plugin && this.plugins.add(utils.append(plugins, plugin)))
      return () => {
  ...
  function progressMonitorPlugin(progress) {
    ...
    const onProgress = {
      ...
      action(_data, context) {
        ...
        ;(_a = context.spawned.stderr) === null || _a === void 0
          ? void 0
          : _a.on('data', (chunk) => {
              const message = /^([a-zA-Z ]+):\s*(\d+)% \((\d+)\/(\d+)\)/.exec(
                chunk.toString('utf8')
              )
              if (!message) {
                return
      ...
      return {
        ...
        action(_data, context) {
          ...
          function kill() {
            stop()
            context.kill(
              new gitPluginError.GitPluginError(undefined, 'timeout', `block timeout reached`)
            )
          }
...
var gitExecutorChain = createCommonjsModule(function (module, exports) {
  ...
  class GitExecutorChain {
    ...
    onFatalException(task, e) {
      const gitError$1 =
        e instanceof gitError.GitError
          ? Object.assign(e, { task })
          : new gitError.GitError(task, e && String(e))
      this._chain = Promise.resolve()
    ...
    attemptRemoteTask(task$1, logger) {
      return __awaiter(this, void 0, void 0, function* () {
        const args = this._plugins.exec(
          'spawn.args',
          [...task$1.commands],
          pluginContext(task$1, task$1.commands)
        )
    ...
    handleTaskData(task, args, result, logger) {
      ...
      return new Promise((done, fail) => {
        ...
        const { error } = this._plugins.exec(
          'task.error',
          { error: rejection },
          Object.assign(Object.assign({}, pluginContext(task, args)), result)
        )
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((done) => {
          ...
          this._plugins.exec(
            'spawn.after',
            undefined,
            Object.assign(Object.assign({}, pluginContext(task, args)), {
              spawned,
              kill(reason) {
                if (spawned.killed) {
                  return
  ...
  function taskCallback(task, response, callback = utils.NOOP) {
    ...
    const onError = (err) => {
      if ((err === null || err === void 0 ? void 0 : err.task) === task) {
        callback(
          err instanceof gitResponseError.GitResponseError ? addDeprecationNoticeToError(err) : err,
          undefined
        )
      }
    }
...
var parseListLogSummary = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, '__esModule', { value: true })
  exports.createListLogSummaryParser =
    exports.SPLITTER =
    ...
    return {
      log(...rest) {
        ...
        const task =
          ...
          createLogTask(
            parseLogOptions(
              utils.trailingOptionsArgument(arguments),
              utils.filterType(arguments[0], utils.filterArray)
            )
          )
...
var StatusSummary_1 = createCommonjsModule(function (module, exports) {
  ...
  const parsers = new Map([
    ...
    parser(
      ...
      (result, file) =>
        utils.append(result.created, file) &&
        utils.append(result.staged, file) &&
        utils.append(result.modified, file)
    ),
    parser(
      PorcelainFileStatus.DELETED,
      PorcelainFileStatus.NONE,
      (result, file) => utils.append(result.deleted, file) && utils.append(result.staged, file)
    ),
    parser(
      PorcelainFileStatus.MODIFIED,
      PorcelainFileStatus.NONE,
      (result, file) => utils.append(result.modified, file) && utils.append(result.staged, file)
    ),
    parser(
      PorcelainFileStatus.MODIFIED,
      PorcelainFileStatus.MODIFIED,
    ...
    parser(PorcelainFileStatus.UNTRACKED, PorcelainFileStatus.UNTRACKED, (result, file) =>
      utils.append(result.not_added, file)
    ),
    ...conflicts(
      PorcelainFileStatus.ADDED,
      PorcelainFileStatus.ADDED,
...
var simpleGitApi = createCommonjsModule(function (module, exports) {
  ...
  class SimpleGitApi {
    ...
    add(files) {
      return this._runTask(
        task.straightThroughStringTask(['add', ...utils.asArray(files)]),
        utils.trailingFunctionArgument(arguments)
      )
    }
    cwd(directory) {
      ...
      if (typeof directory === 'string') {
        return this._runTask(
          changeWorkingDirectory.changeWorkingDirectoryTask(directory, this._executor),
          next
        )
      }
      if (
        typeof (directory === null || directory === void 0 ? void 0 : directory.path) === 'string'
      ) {
        return this._runTask(
      ...
      return this._runTask(
        task.configurationErrorTask('Git.cwd: workingDirectory must be supplied as a string'),
        next
      )
    }
    hashObject(path, write) {
      return this._runTask(
        hashObject.hashObjectTask(path, write === true),
        utils.trailingFunctionArgument(arguments)
      )
    }
    init(bare) {
      return this._runTask(
        init.initTask(bare === true, this._executor.cwd, utils.getTrailingOptions(arguments)),
        utils.trailingFunctionArgument(arguments)
      )
    }
    merge() {
      return this._runTask(
        merge.mergeTask(utils.getTrailingOptions(arguments)),
        utils.trailingFunctionArgument(arguments)
      )
    }
    mergeFromTo(remote, branch) {
      ...
      return this._runTask(
        merge.mergeTask([remote, branch, ...utils.getTrailingOptions(arguments)]),
        utils.trailingFunctionArgument(arguments, false)
      )
    }
    ...
    stash() {
      return this._runTask(
        task.straightThroughStringTask(['stash', ...utils.getTrailingOptions(arguments)]),
        utils.trailingFunctionArgument(arguments)
      )
    }
    status() {
      return this._runTask(
        status.statusTask(utils.getTrailingOptions(arguments)),
        utils.trailingFunctionArgument(arguments)
      )
    }
  }
...
var BranchDeleteSummary = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, '__esModule', { value: true })
  exports.isSingleBranchDeleteFailure =
    exports.branchDeletionFailure =
    exports.branchDeletionSuccess =
    exports.BranchDeletionBatch =
      void 0
...
var branch = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, '__esModule', { value: true })
  exports.deleteBranchTask =
    exports.deleteBranchesTask =
    exports.branchLocalTask =
    exports.branchTask =
    exports.containsDeleteBranchCommand =
      void 0
    ...
    const task = {
      ...
      onError({ exitCode, stdErr, stdOut }, error, _, fail) {
        ...
        throw new gitResponseError.GitResponseError(
          task.parser(utils.bufferToString(stdOut), utils.bufferToString(stdErr)),
          String(error)
        )
      },
    }
...
var remote = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, '__esModule', { value: true })
  exports.removeRemoteTask =
    exports.remoteTask =
    exports.listRemotesTask =
    exports.getRemotesTask =
    exports.addRemoteTask =
      void 0
...
var subModule = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, '__esModule', { value: true })
  exports.updateSubModuleTask =
    exports.subModuleTask =
    exports.initSubModuleTask =
    exports.addSubModuleTask =
      void 0
...
Git.prototype.commit = function (message, files, options, then) {
  ...
  return this._runTask(
    commitTask(messages, asArray(filterType(files, filterStringOrStringArray, [])), [
...
var gitFactory = createCommonjsModule(function (module, exports) {
  ...
  function gitInstanceFactory(baseDir, options) {
    ...
    const config = utils.createInstanceConfig(
      (baseDir && (typeof baseDir === 'string' ? { baseDir } : baseDir)) || {},
      options
    )
    if (!utils.folderExists(config.baseDir)) {
      throw new api_1.default.GitConstructError(
        config,
...
var src = esModuleFactory(gitExportFactory(gitInstanceFactory, { gitP }))
      ...
      return __generator(this, function (_j) {
        switch (_j.label) {
          case 0:
            ...
            return [3 /*break*/, 3]
          case 1:
            return [4 /*yield*/, this.formatCommitMessage()]
          case 2:
            _e = _j.sent()
            _j.label = 3
          case 3:
          ...
          case 8:
            ...
            _j.label = 9
          case 9:
            return [4 /*yield*/, _g.apply(_f, [_h])]
          case 10:
            return [2 /*return*/, _j.sent().summary.changes]
        }
      })
    })
  }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.git.subModule(['update', '--remote', '--merge', '--recursive'], function (err) {
                return _this.onError(err)
              }),
            ]
          case 1:
          ...
          case 2:
            return [
              4 /*yield*/,
              this.git.pull(['--no-rebase'], function (err) {
                return __awaiter(_this, void 0, void 0, function () {
                  var status_1
                  return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.git
                .env(__assign(__assign({}, process.env), { OBSIDIAN_GIT: 1 }))
                .subModule(
                  [
                    'foreach',
                    '--recursive',
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.git.branch(['--no-color'], function (err) {
                return _this.onError(err)
              }),
            ]
          case 2:
  ...
  SimpleGit.prototype.init = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.git.init(false)]
          case 1:
            _a.sent()
            return [2 /*return*/]
        }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.git.addConfig(path, value, function (err) {
                return _this.onError(err)
              }),
            ]
          case 1:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.git.listConfig(function (err) {
                return _this.onError(err)
              }),
            ]
          case 1:
...
var ObsidianGit = /** @class */ (function (_super) {
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            this.addCommand({
              ...
              callback: function () {
                return _this.promiseQueue.addTask(function () {
                  return _this.pullChangesFromRemote()
                })
              },
            })
            this.addCommand({
              ...
              callback: function () {
                return _this.promiseQueue.addTask(function () {
                  return _this.createBackup(false)
                })
              },
            })
            this.addCommand({
              ...
              callback: function () {
                return new CustomMessageModal(_this).open()
              },
            })
            this.addCommand({
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_c) {
        return [
          ...
          {
            backup: new Date(
              (_a = window.localStorage.getItem(this.manifest.id + ':lastAutoBackup')) !== null &&
              _a !== void 0
                ? _a
                : ''
            ),
            pull: new Date(
              (_b = window.localStorage.getItem(this.manifest.id + ':lastAutoPull')) !== null &&
              _b !== void 0
                ? _b
                : ''
            ),
        ...
        switch (_b.label) {
          ...
          case 4:
            ...
            if (this.settings.autoPullOnBoot) {
              this.promiseQueue.addTask(function () {
                return _this.pullChangesFromRemote()
              })
            }
          ...
          case 5:
            ...
            if (this.settings.autoSaveInterval > 0) {
              ...
              diff =
                ...
                Math.round((now.getTime() - lastAutos.backup.getTime()) / 1000 / 60)
            ...
            if (this.settings.autoPullInterval > 0) {
              ...
              diff =
                ...
                Math.round((now.getTime() - lastAutos.pull.getTime()) / 1000 / 60)
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            _a.label = 2
          case 2:
            if (!this.gitReady) return [2 /*return*/]
        ...
        switch (_b.label) {
          ...
          case 5:
            ...
            if (fromAutoBackup && status_2.conflicted.length > 0) {
              this.setState(PluginState.idle)
              this.displayError(
                'Did not commit, because you have ' +
                  status_2.conflicted.length +
                  ' conflict files. Please resolve them and commit per command.'
              )
          ...
          case 11:
            if (!_b.sent().tracking) {
              this.displayError(
                'Did not push. No tracking branch is set! Please set one in the settings',
                10000
              )
              this.setState(PluginState.idle)
              return [2 /*return*/]
          ...
          case 16:
            ...
            this.displayError(
              'Cannot push. You have ' + status_3.conflicted.length + ' conflict files'
            )
            this.handleConflict(status_3.conflicted)
            return [2 /*return*/]
          case 17:
            return [4 /*yield*/, this.gitManager.push()]
          case 18:
            pushedFiles = _b.sent()
  ...
  ObsidianGit.prototype.startAutoBackup = function (minutes) {
    ...
    this.timeoutIDBackup = window.setTimeout(function () {
      _this.promiseQueue.addTask(function () {
        return _this.createBackup(true)
      })
  ...
  ObsidianGit.prototype.writeAndOpenFile = function (text) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.app.vault.adapter.write(this.conflictOutputFile, text)]
          case 1:
            _a.sent()
  ...
  ObsidianGit.prototype.displayMessage = function (message, timeout) {
    ...
    ;(_a = this.statusBar) === null || _a === void 0
      ? void 0
      : _a.displayMessage(message.toLowerCase(), timeout)
